...
export default function DashboardPage() {
    ...
    if (stats.pendingOnboarding > 0) attentionItems.push({ icon: Icons.user, label: `${stats.pendingOnboarding} employee${stats.pendingOnboarding > 1 ? 's' : ''} completed onboarding — review and approve`, severity: 'warning', action: () => navigate('/employees?onboarding=pending_review') });
