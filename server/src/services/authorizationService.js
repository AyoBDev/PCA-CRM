...
const REMINDER_WINDOWS = {
  ...
  TIMESHEETS: 15,
  TIMESHEET_PCS: 15,
  TIMESHEET_HOMEMAKER: 15,
  TIMESHEET_RESPITE: 15,
  TIMESHEET_COMPANION: 15,
  TIMESHEET_CHORE: 15,
  COPE: 30,
  PAS: 30,
  S5120: 30,
...
const RENEWAL_COLORS = {
  ...
  SDPC: 'YELLOW',
  TIMESHEETS: 'ORANGE',
  TIMESHEET_PCS: 'ORANGE',
  TIMESHEET_HOMEMAKER: 'ORANGE',
  TIMESHEET_RESPITE: 'ORANGE',
  TIMESHEET_COMPANION: 'ORANGE',
  TIMESHEET_CHORE: 'ORANGE',
  COPE: 'ORANGE',
  PAS: 'ORANGE',
  S5120: 'ORANGE',
  S5125: 'ORANGE',
...
function enrichAuthorization(auth) {
  ...
  return {
    ...
    renewedFromId: auth.renewedFromId ?? null,
    renewedToId: auth.renewedToId ?? null,
    inactiveReason: auth.inactiveReason || '',
    inactiveNote: auth.inactiveNote || '',
    closedAt: auth.closedAt ?? null,
    daysToExpire,
    status,
    statusColor,
    documents,
