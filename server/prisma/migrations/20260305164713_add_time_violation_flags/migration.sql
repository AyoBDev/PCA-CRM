...
INSERT INTO "new_payroll_visits" ("call_hours_raw", "call_in_raw", "call_in_time", "call_out_raw", "call_out_time", "client_name", "created_at", "duration_minutes", "employee_name", "final_payable_units", "id", "is_incomplete", "is_unauthorized", "needs_review", "notes", "overlap_id", "review_reason", "run_id", "service", "service_code", "units_raw", "visit_date", "visit_status", "void_flag", "void_reason") SELECT "call_hours_raw", "call_in_raw", "call_in_time", "call_out_raw", "call_out_time", "client_name", "created_at", "duration_minutes", "employee_name", "final_payable_units", "id", "is_incomplete", "is_unauthorized", "needs_review", "notes", "overlap_id", "review_reason", "run_id", "service", "service_code", "units_raw", "visit_date", "visit_status", "void_flag", "void_reason" FROM "payroll_visits";
