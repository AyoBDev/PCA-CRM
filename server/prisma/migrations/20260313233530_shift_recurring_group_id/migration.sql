...
INSERT INTO "new_shifts" ("client_id", "created_at", "employee_id", "employee_name", "end_time", "hours", "id", "notes", "service_code", "shift_date", "start_time", "status", "units", "updated_at") SELECT "client_id", "created_at", "employee_id", "employee_name", "end_time", "hours", "id", "notes", "service_code", "shift_date", "start_time", "status", "units", "updated_at" FROM "shifts";
DROP TABLE "shifts";
